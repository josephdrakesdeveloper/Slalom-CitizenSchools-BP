...
var transporter = nodemailer.createTransport({
  service: 'Gmail',
  auth: {
    user: 'josephdrakesdeveloper@gmail.com',
    pass: 'ilovecode1'
  }
});
...
function sendMail(mailData){
  ...
  var mailOptions = {
    from: 'Joseph ✔ <josephdrakesdeveloper@gmail.com>', // sender address
    to: 'josephdrakesdeveloper@gmail.com, bailey1.brandon@gmail.com ' + mailData.email, // list of receivers
